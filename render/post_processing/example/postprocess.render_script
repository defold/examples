...
local function create_postprocess_rt(self, width, height)
    ...
    self.postprocess_rt =  render.render_target("postprocess_rt", { [graphics.BUFFER_TYPE_COLOR0_BIT] = color_params, [graphics.BUFFER_TYPE_DEPTH_BIT] = depth_params } )
...
function update(self)
    ...
    render.enable_texture(0, self.postprocess_rt, graphics.BUFFER_TYPE_COLOR0_BIT)
